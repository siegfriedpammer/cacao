 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_gnu_java_awt_peer_gtk_GtkScrollPanePeer_gtkScrolledWindowSetScrollPosition (JNIEnv *env ,  struct 
gnu_java_awt_peer_gtk_GtkScrollPanePeer* this , s4 par1, s4 par2) {
}
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_gnu_java_awt_peer_gtk_GtkScrollPanePeer_gtkScrolledWindowSetSize (JNIEnv *env ,  struct 
gnu_java_awt_peer_gtk_GtkScrollPanePeer* this , s4 par1, s4 par2) {
}
