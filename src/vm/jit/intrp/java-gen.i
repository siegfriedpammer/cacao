...
void gen_ACONST1(Inst **ctp, java_objectheader * aRef, constant_classref * acrUnused)
{
  gen_inst(ctp, vm_prim[3]);
  genarg_aRef(ctp, aRef);
  genarg_acr(ctp, acrUnused);
}
void gen_PATCHER_ACONST(Inst **ctp, java_objectheader * aRef, constant_classref * acr)
{
...
void gen_ARRAYCHECKCAST(Inst **ctp, classinfo * aClass, constant_classref * acr)
{
...
void gen_PATCHER_MULTIANEWARRAY(Inst **ctp, classinfo * aClass, s4 iSize, constant_classref * acr)
{
