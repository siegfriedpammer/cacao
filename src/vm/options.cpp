...
#if defined(ENABLE_RT_TIMING)
	{ "RtTimingLogfile",              OPT_RtTimingLogfile,              OPT_TYPE_VALUE,   "rt-timing logfile (default: rt-timing.log, use - for stderr)" },
#endif
#if defined(ENABLE_STATISTICS)
	{ "StatisticsLogfile",            OPT_StatisticsLogfile,           OPT_TYPE_VALUE,   "statistics logfile (default: statistics.log, use - for stderr)" },
#endif
#if defined(ENABLE_VMLOG)
