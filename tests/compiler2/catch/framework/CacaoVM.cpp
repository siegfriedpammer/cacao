/* tests/compiler2/catch/framework/CacaoVM.cpp - CacaoVM
...
bool CacaoVM::initialized = false;

void CacaoVM::initialize()
{
	...
	vm_args->nOptions = 0;
	vm_args->options = (JavaVMOption*)malloc(sizeof(JavaVMOption) * 1);
