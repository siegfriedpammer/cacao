...
public class ParameterLong extends Compiler2TestBase {
	...
	public ParameterLong(long x0, long x1, long x2, long x3, long x4, long x5, long x6, long x7, long x8) {
		this.x0 = x0;
		this.x1 = x1;
		this.x2 = x2;
		this.x3 = x3;
    ...
    public void testParameterLong1() {
		testResultEqual("parameterLong1", "(JJJJJJJJJ)J", x0, x1, x2, x3, x4, x5, x6, x7, x8);
    }

    @Test
    public void testParameterLong2() {
		testResultEqual("parameterLong2", "(JJJJJJJJJ)J", x0, x1, x2, x3, x4, x5, x6, x7, x8);
    }

    @Test
    public void testParameterLong3() {
		testResultEqual("parameterLong3", "(JJJJJJJJJ)J", x0, x1, x2, x3, x4, x5, x6, x7, x8);
    }

	static long parameterLong1(long a, long b, long c, long d, long e, long f, long g, long h, long i) {
		return a+b+c+d+e+f+g+h+i;
	}

	static long parameterLong2(long a, long b, long c, long d, long e, long f, long g, long h, long i) {
		return a+c+e+g+i;
	}

	static long parameterLong3(long a, long b, long c, long d, long e, long f, long g, long h, long i) {
		return b+d+f+h;
	}
}
